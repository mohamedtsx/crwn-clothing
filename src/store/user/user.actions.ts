...
export type SetCurrentUserSuccess = ActionWithPayload<USER_ACTION_TYPES.SET_CURRENT_USER, UserData>;
...
export const setCurrentUserSuccess = withMatcher(
    (user: UserData): SetCurrentUserSuccess => 
...
export const signInSuccess = withMatcher(
    (user: UserData, additionalDetails: AdditionalUserInfo) => 
...
export const signUpSuccess = withMatcher(
    (user: UserData, more: AdditionalUserInfo): SignUpSuccess => 
    createAction(USER_ACTION_TYPES.SIGN_UP_SUCCESS, {user,more})
);
